...
if(isset( $_POST["user_id"]) && isset( $_POST["Submit"]) && isset( $_POST["Firstname"])  && isset( $_POST["Lastname"]) && isset( $_POST["Phone Number"]) && isset( $_POST["Address"]) && isset( $_POST["Date of Payment"]) && isset( $_POST["Mode of Payment"]) && isset( $_POST["Mosque name"])){
    ...
    if( !empty( $user_id) && !empty( $Firstname) && !empty( $Lastname) && !empty( $Phone_number) && !empty( $Address) && !empty( $dop) && !empty( $mop) && !empty( $Mosque_name))
    {

  $sql = "UPDATE contributors SET Firstname = '$Firstname',`Lastname` ='$Lastname',`Phone Number` ='$Phone_number',`Address` ='$Address',`Date 0f Payment`='$dop',Mode of Payment ='$mop',`Mosque name` ='$Mosque_name' WHERE user_id ='$user_id'";
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="mosque.html">
          ...
          <li class="nav-item">
            <a class="nav-link" href="collectors.html">
...
<input type="text" class="form-control" placeholder="firstname" name="firstnaem">
     ...
     <button type="submit" class="btn btn-success  btn-lg text-white rounded-pill mx-auto d-block m-3"
            style="width: 150px;">UPDATE</button> <button type="submit" class="btn btn-grey  btn-lg text-white rounded-pill mx-auto d-block m-5"

      ...
      <P class="f">Add a contributor</P>
       ...
       <div class="form-control">
         <form action="" method="POST" class="form-control">
           <div class="mb-3">
<label for="firstn">user_id</label>
<input type="text" class="form-control" placeholder="user_id" name="user_id">
           </div>
     <button type="Delete" class="btn btn-success  btn-lg text-white rounded-pill mx-auto d-block m-3"
            style="width: 150px;">DELETE</a></button>
